...
#ifndef __MYCLASSVEP_H
#define __MYCLASSVEP_H
...
class MiClaseVEP {
 ...
 public:
  MiClaseVEP(double Energ, int sigN, double L, double rhomat, double th[3], double dCP, double dm[2], double gamma[3], double P[3][3])
	{	
