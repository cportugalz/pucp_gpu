...
int main(int argc, char *argv[]) {
    ...
    const std::vector<data_type> A = { 
        make_cuDoubleComplex(8.216101e-01, 0.0), 
        make_cuDoubleComplex(-3.714239e-01, 9.246545e-02), 
        make_cuDoubleComplex(4.142244e-01, 8.288165e-02), 
        make_cuDoubleComplex(5.501137e-01, 0.0), 
        make_cuDoubleComplex(5.545727e-01, 6.191077e-02), 
        make_cuDoubleComplex(-6.187985e-01, 5.549388e-02), 
        make_cuDoubleComplex(1.190016e-04, 1.494381e-01), 
    ...
    const std::vector<data_type> B = { 
        ...
        make_cuDoubleComplex(0.0, 0.0),    
        make_cuDoubleComplex(0.0, 0.0),
        make_cuDoubleComplex(3.700000e-12, -0.0),  
        make_cuDoubleComplex(0.0, 0.0),  
        make_cuDoubleComplex(0.0, 0.0),  
        make_cuDoubleComplex(0.0, 0.0),  
